 ...
 */
final class Version20250206004825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD statut VARCHAR(255) DEFAULT NULL, ADD id_transaction VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment DROP statut, DROP id_transaction');
